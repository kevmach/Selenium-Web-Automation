...
public class VerifyTotalCost {
    String output1="";
    WebDriver driver = new FirefoxDriver();
    public String verifytotalcost(String url, String Email, String Password) throws InterruptedException{
        driver.get(url);
        ...
        //Handling Slider
        //WebElement priceslider = driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div[3]/div[1]/div[1]/div[1]/form/div/div[10]/ul/label"));
        //Thread.sleep(1000);

        ///html/body/div[1]/div[2]/div/div[3]/div[1]/div[1]/div[1]/form/div/div[10]/ul/div/div/a[1]
...
//Mouse hover menuOption 'Rock'
        ...
        String totalshipping = driver.findElement(By.xpath("/html/body/div[1]/div[1]/header/div[3]/div/div/div[4]/div[1]/div[2]/div[2]/span")).getText();
        System.out.print(totalshipping);

        WebElement total = driver.findElement(By.xpath("/html/body/div[1]/div[1]/header/div[3]/div/div/div[4]/div[1]/div[2]/div[3]/span"));
        if (total.getText().contains("$154.97")) {
            output1 = "Correct Calculation";
        } else {
            output1 = "Incorrect Calculation";
        }
        ...
        //Printing Color and Size
        String colorsize = driver.findElement(By.xpath("//*[@id=\"layer_cart_product_attributes\"]")).getText();
        System.out.print("Color & Size:" +colorsize);

        //Printing TotalProductCost
        String totalproductcost = driver.findElement(By.xpath("/html/body/div[1]/div[1]/header/div[3]/div/div/div[4]/div[1]/div[2]/div[1]/span")).getText();
        System.out.print("TotalProductCost:" +totalproductcost);

        //Printing ShippingCost
        String shippingcost = driver.findElement(By.xpath("/html/body/div[1]/div[1]/header/div[3]/div/div/div[4]/div[1]/div[2]/div[2]/span")).getText();
        System.out.print("Shipping cost:" +shippingcost);


        //Printing ShippingCost
        String totalcost = driver.findElement(By.xpath("/html/body/div[1]/div[1]/header/div[3]/div/div/div[4]/div[1]/div[2]/div[3]/span")).getText();
        System.out.print("Shipping cost:" +totalcost);
